...
typedef struct
{
    ...
    int32_t (*conversion_func)(uint32_t data);  //Pointer to a function that converts the value read from CAN.
...
/**
 * Sets the CAN fram that should be transmitted to get the ECU to return
