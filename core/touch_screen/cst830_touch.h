...
void cst830_timer_tasks();				//Checks how long its been since last update and updates data if necessary.
void cst830_tick_inc(uint32_t ms);		//Increments timer.
