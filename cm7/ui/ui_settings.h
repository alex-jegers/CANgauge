...
bool ui_settings_set_pressure_units_dropdown(const char* units_str);	//Units_str must be PSI, kPa, or bar. Anything else will return false.
bool ui_settings_set_temperature_units_dropdown(const char* units_str);	//Units_str must be C or F. Anything else will return false.
